...
## 明确不做
- 支付生产、APNs/FCM、完整 WebPush 服务、RegimeTrader、假承运商轨迹。

## 后续（依赖外部账号）
- 支付生产网关、APNs/FCM、Shopee/TikTok ISV 与沙箱实机。
- 多站点 partner / TikTok 轨迹路径 / Redis 限流开关：见后续 commit 与 [`PRODUCT_STATUS.md`](./PRODUCT_STATUS.md)。
