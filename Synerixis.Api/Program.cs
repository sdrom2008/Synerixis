...
builder.Services.AddControllers()
    .AddJsonOptions(options =>
    {
        ...
        options.JsonSerializerOptions.ReferenceHandler = ReferenceHandler.IgnoreCycles; // 避免 $values 包装打断 merchant-web 列表
    });
...
builder.Services.AddScoped<ISessionAssignmentService, Synerixis.Infrastructure.Services.SessionAssignmentService>();
builder.Services.AddScoped<ICbecI18nService, Synerixis.Infrastructure.Services.CbecI18nService>();
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            // 与 AuthService 写入的 ClaimTypes.Role / "role" 对齐
